...
export function CrtTerminalVisual({ data, status, visual, preview }: RadioVisualProps) {
  const clock = useRadioClock()
  return (
    <RadioVisualShell className="rdv--crt" data={data} visual={visual} preview={preview}>
