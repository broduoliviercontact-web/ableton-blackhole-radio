...
const shaderVisual = resolveVisual({ visualization: 'shader-radio', shaderPreset: 'tape-noise', shaderQuality: 'high' })
assert(shaderVisual.visualization === 'shader-radio' && shaderVisual.shaderPreset === 'tape-noise' && shaderVisual.shaderQuality === 'high', 'shader radio resolve preset/quality')
